const Map<String, String> en = {
  ...
  'Hi ': 'Hi ',
  'Doctor Specialist': 'Advisor Specialist',
  'Top Rated Doctor': 'Top Rated Advisor',
  'Search Doctor': 'Search Advisor',
  'View All': 'View All',
  'error ': 'error ',
  'Top Rated Doctor is empty ': 'Top Rated Advisor is empty ',
  'Home': 'Home',
  'Doctor': 'Advisor',
  ...
  'No Doctor Registered in this Category':
      'No Advisor Registered in this Category',
  'Price': 'Price',
  ...
  'the doctor has not started the meeting session, this button will automatically turn on when the doctor has started it':
      'the advisor has not started the meeting session, this button will automatically turn on when the advisor has started it',
  'The doctor hasn\'t started the consultation yet':
      'The advisor hasn\'t started the consultation yet',
  'Photo': 'Photo',
  'File': 'File',
  'Cancel': 'Cancel',
  ...
  'Payment for doctor ': 'Payment for Advisor ',
  ...
  'Send': 'Send',
  'Doctor no longger exist': 'Advisor no longger exist',
